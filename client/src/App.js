...
const DailymotionIcon = ({ size = 18 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" aria-label="Dailymotion">
    <circle cx="12" cy="12" r="12" fill={PLATFORM_BRAND.dailymotion.icon} />
    <circle cx="9.2" cy="12" r="3.2" fill="none" stroke="#fff" strokeWidth="2.2" />
    <rect x="12.5" y="5.2" width="2.8" height="13.6" rx="1.4" fill="#fff" />
  </svg>
);
